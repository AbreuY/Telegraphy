...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Region region = (Region) LocalPersistence.readObjectFromFile(this, "region");
    ...
    private void load(Region region) {
        ...
        RadioStations.getStations(region, new RadioStations.RadioCallback() {
            @Override
            public void success(List<Radio> radios) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        findViewById(R.id.progress).setVisibility(View.GONE);
                        findViewById(R.id.stations).setVisibility(View.VISIBLE);

                        // set up the RecyclerView
                        RecyclerView recyclerView = findViewById(R.id.stations);
                        int numberOfColumns = 3;
                        recyclerView.setLayoutManager(new GridLayoutManager(MainActivity.this, numberOfColumns));
                        adapter = new RadioAdapter(MainActivity.this, radios);
                        adapter.setClickListener(new RadioAdapter.ItemClickListener() {
                            @Override
